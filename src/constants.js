export const TRAIN_STATIC_DATA = [
  {
    id: 'roca',
    name: 'Roca',
    ramales: [
        ...
        estaciones: [
          {
            id: 'constitucion',
            name: 'Constitucion',
            posicion: {lat: -34.6283673, lng: -58.3806149}
          },
          {
            id: 'avellaneda',
            name: 'Avellaneda',
            posicion: {lat: -34.6613896, lng: -58.3768325}
          },
          {
            id: 'sarandi',
            name: 'Sarandi',
            posicion: {lat: -34.6787475, lng: -58.3449626}
          },
          {
            id: 'villaDominico',
            name: 'Villa Dominico',
            posicion: {lat: -34.6915355, lng: -58.3253499}
          },
          {
            id: 'wilde',
            name: 'Wilde',
            posicion: {lat: -34.6975894, lng: -58.3111938}
          },
          {
            id: 'donBosco',
            name: 'Don Bosco',
            posicion: {lat: -34.7033242, lng: -58.2961718}
          },
          {
            id: 'bernal',
            name: 'Bernal',
            posicion: {lat: -34.7092611, lng: -58.2805690}
          },
          {
            id: 'quilmes',
            name: 'Quilmes',
            posicion: {lat: -34.7246461, lng: -58.2606591}
          },
          {
            id: 'ezpeleta',
            name: 'Ezpeleta',
            posicion: {lat: -34.7518509, lng: -58.2341863}
          },
          {
            id: 'berazategui',
            name: 'Berazategui',
            posicion: {lat: -34.7640977, lng: -58.2084433}
          },
          {
            id: 'platanos',
            name: 'Platanos',
            posicion: {lat: -34.7823359, lng: -58.1707596}
          },
          {
            id: 'hudson',
            name: 'Hudson',
            posicion: {lat: -34.7911192, lng: -58.1552692}
          },
          {
            id: 'pereyra',
            name: 'Pereyra',
            posicion: {lat: -34.8366304, lng: -58.0945403}
          },
          {
            id: 'villaElisa',
            name: 'Villa Elisa',
            posicion: {lat: -34.8495861, lng: -58.0751851}
          },
          {
            id: 'cityBell',
            name: 'City Bell',
            posicion: {lat: -34.8657239, lng: -58.0420495}
          },
          {
            id: 'gonnet',
            name: 'Gonnet',
            posicion: {lat: -34.8798410, lng: -58.0107856}
          },
          {
            id: 'ringuelet',
            name: 'Ringuelet',
            posicion: {lat: -34.8813876, lng: -57.9960622}
          },
          {
            id: 'tolosa',
            name: 'Tolosa',
            posicion: {lat: -34.8909547, lng: -57.9680983}
          },
          {
            id: 'laPlata',
            name: 'La Plata',
            posicion: {lat: -34.9038945, lng: -57.9501740}
          }
        ],
